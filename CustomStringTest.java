...
class CustomStringTest {
	...
	void testFilterLetters() {
		...
		assertEquals("fg", this.myCustomString.filterLetters('E', false));
		
		this.myCustomString.setString("abfdeg");
		assertEquals("abd", this.myCustomString.filterLetters('E', true));
	}
